diff --git a/solar_insolation_app.py b/solar_insolation_app.py
new file mode 100644
index 0000000000000000000000000000000000000000..87a9f233796644f0812f21c83c515f0a5675fb09
--- /dev/null
+++ b/solar_insolation_app.py
@@ -0,0 +1,572 @@
